...
type Props = BaseProps & Omit<React.ComponentPropsWithoutRef<'input'>, keyof BaseProps>;

export const Input = ({ className, placeholder, variant = 'solid', ...props }: Props) => {
  return (
    <input
      className={cn(
        'rounded-lg px-2.5 py-2 outline-0 duration-300',
